...
export default function PersonEvaluation() {
    ...
    async function fetchData() {
      try {
        ...
        setIndividual({
          ...
          grade: detail.grade,
          workGuidelinesPrimaryEvaluatorName: detail.workGuidelinesPrimaryEvaluatorName,
          workGuidelinesSecondaryEvaluatorName: detail.workGuidelinesSecondaryEvaluatorName,
          workGuidelinesFinalEvaluatorName: detail.workGuidelinesFinalEvaluatorName,
        });
  ...
  return (
    <div className="p-4">
      ...
      <h1 className="text-xl font-bold mb-4">個人評価詳細：働き方の指針</h1>
        ...
        <table className="border-collapse border w-10/12">
          ...
          <tbody>
            <tr>
              ...
              <td className="p-2 border text-center">{individual.workGuidelinesPrimaryEvaluatorName}</td>
              <td className="p-2 border text-center">{individual.workGuidelinesSecondaryEvaluatorName}</td>
              <td className="p-2 border text-center">{individual.workGuidelinesFinalEvaluatorName}</td>
              <td className="p-2 border text-center">{scores.workGuidelines}%</td>
            </tr>
          </tbody>
        </table>
